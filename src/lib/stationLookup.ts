...
const STATIONS: Record<string, StationEntry> = {
  ...
  'guildwood go': { lat: 43.755, lng: -79.1983, label: 'Guildwood GO', placeType: 'train_station' },
  guildwood: { lat: 43.755, lng: -79.1983, label: 'Guildwood GO', placeType: 'train_station' },
  'union station rail': { lat: 43.6452, lng: -79.3806, label: 'Union Station GO', placeType: 'train_station' },
